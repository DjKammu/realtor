...
const Index = (props) => {
      const deleteFunc = (e) => {
        ...
        Inertia.post('/leasing-status/'+id, {
            _method: 'delete',
            preserveScroll: true,
          },{
        ...
        <div>
            <Layout>
                ...
                <div className="header">
                    <h1 className="header-text">Leasing Statuses</h1>
                </div>
                       <div className="">
                           <div className="p-6 bg-white border-b border-gray-200">
                            <InertiaLink href="/leasing-status/create" className="p-2 mt-8 text-lg font-bold text-white bg-black hover:bg-gray-700">
                            Create Leasing Status
                            </InertiaLink>
                            </div>
                                            ...
                                            {statuses.data.map((status,key) => (
                                                <tr key={key}>
                                                    ...
                                                    <td className="border px-4 py-2">        
                                                        <InertiaLink href={`/leasing-status/${status.id}`} >
