...
const Edit = (props) => {
  ...
  const handleSubmit = e => {
      ...
      Inertia.post('/leasing-status/'+status.id, {
          _method: 'put',
          name: form.name,
        ...
        <div>
            <Layout>
                ...
                <div className="header">
                    <h1 className="header-text">Edit Leasing Status</h1>
                </div>
                     
               <div className="md:grid md:grid-cols-4 md:gap-6">     
                            
               <div className="md:col-span-1">
                <InertiaLink href="/leasing-status" className="p-2 mt-8 text-lg font-bold text-white bg-black hover:bg-gray-700">
                  Back to Leasing Statuses
                  </InertiaLink>
              </div>
              {/* right side */}
