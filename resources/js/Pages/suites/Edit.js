...
const Edit = (props) => {
  ...
  const { suite , properties } = usePage().props
  const selectedOption  =  properties.filter(item =>
               item.value == suite.property_id); 

  const [form, setForm] = useState({
      name: suite.name,
      account_number: suite.account_number,
        ...
        <div>
            <Layout>
                ...
                <div className="header">
                    <h1 className="header-text">Edit Suite</h1>
                </div>
