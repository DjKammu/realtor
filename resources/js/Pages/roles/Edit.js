...
const Edit = (props) => {
  ...
  const handleChange = e =>   {
    ...
    const handleCheckboxChange = event => {
     ...
     useEffect(() => {
          setPermissions(role.permissionsArray);
      }, [])
        ...
        <div>
            <Layout>
                ...
                <div className="header">
                    <h1 className="header-text">Edit Role</h1>
                </div>
                    ...
                    <div className="col-span-12 sm:col-span-12">
                      ...
                      <label className=" text-sm font-medium text-gray-700 mr-1" htmlFor="view">
                        <span className="mr-1">View</span>
                           ...
                           <input type="checkbox" id="view"  
                               ...
                               defaultChecked={role.permissions.includes('view')}
                              />
                      ...
                      <label className=" text-sm font-medium text-gray-700 mr-1" htmlFor="add">
                        ...
                        <input type="checkbox" id="add"  
                           value="add"
                           onChange={handleCheckboxChange}
                           defaultChecked={role.permissions.includes('add')}
                          />
                      </label>
                      ...
                      <label className=" text-sm font-medium text-gray-700 mr-1" htmlFor="edit">
                        ...
                        <input type="checkbox" id="edit"  
                           value="edit"
                           onChange={handleCheckboxChange}
                           defaultChecked={role.permissions.includes('edit')}
                          />
                      </label>
                      <label className=" text-sm font-medium text-gray-700 mr-1" htmlFor="update">
                        ...
                        <input type="checkbox" id="update"  
                           value="update"
                           onChange={handleCheckboxChange}
                           defaultChecked={role.permissions.includes('update')}
                          />
                      </label> 
                      ...
                      <label className=" text-sm font-medium text-gray-700 mr-1" htmlFor="delete">
                        ...
                        <input type="checkbox" id="delete"  
                           value="delete"
                           onChange={handleCheckboxChange}
                           defaultChecked={role.permissions.includes('delete')}
                          />
                      </label>
                      <label className=" text-sm font-medium text-gray-700 mr-1" htmlFor="add_users">
                        ...
                        <input type="checkbox" id="add_users"  
                           value="add_users"
                           onChange={handleCheckboxChange}
                           defaultChecked={role.permissions.includes('add_users')}
                          />
                      </label>
