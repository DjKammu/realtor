...
const Edit = (props) => {
  ...
  const [form, setForm] = useState({
      ...
      emaill:    realtor.emaill,
      tenant_use_id:    realtor.tenant_use_id
    })

    const handleSubmit = e => {
      e.preventDefault()

      Inertia.post('/realtors/'+realtor.id, {
          _method: 'put',
          name: form.name,
       ...
       <div>
            <Layout>
                ...
                <div className="header">
                    <h1 className="header-text">Edit Realtor</h1>
                </div>
                     
               <div className="md:grid md:grid-cols-4 md:gap-6">     
                            
               <div className="md:col-span-1">
                <InertiaLink href="/realtors" className="p-2 mt-8 text-lg font-bold text-white bg-black hover:bg-gray-700">
                  Back to Realtors
                  </InertiaLink>
              </div>
              {/* right side */}
