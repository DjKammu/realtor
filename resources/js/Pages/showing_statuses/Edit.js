...
const Edit = (props) => {
  ...
  const handleSubmit = e => {
      ...
      Inertia.post('/showing-status/'+status.id, {
          _method: 'put',
          name: form.name,
        ...
        <div>
            <Layout>
                ...
                <div className="header">
                    <h1 className="header-text">Edit Showing Status</h1>
                </div>
                     
               <div className="md:grid md:grid-cols-4 md:gap-6">     
                            
               <div className="md:col-span-1">
                <InertiaLink href="/showing-status" className="p-2 mt-8 text-lg font-bold text-white bg-black hover:bg-gray-700">
                  Back to Showing Statuses
                  </InertiaLink>
              </div>
              {/* right side */}
